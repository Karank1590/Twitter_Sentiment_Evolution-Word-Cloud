...
texts = [
  {key:"coffee",file:"coffee.csv",name:"Coffee"}
  {key:"christmas",file:"christmas.csv",name:"Christmas"}
  {key:"android",file:"android.csv",name:"Android"}
  {key:"twitter",file:"twitter.csv",name:"Twitter"}
  {key:"justinbieber",file:"justinbieber.csv",name:"JustinBieber"}
  {key:"ipad",file:"ipad.csv",name:"iPad"}
  {key:"internet",file:"internet.csv",name:"Internet"}
  {key:"pink",file:"pink.csv",name:"Pink"}
  {key:"snapchat",file:"snapchat.csv",name:"Snapchat"}
  {key:"youtube",file:"youtube.csv",name:"Youtube"}
  {key:"chocolate",file:"chocolate.csv",name:"Chocolate"}
  {key:"facebook",file:"facebook.csv",name:"Facebook"}
  {key:"allah",file:"allah.csv",name:"Allah"}
  {key:"disney",file:"disney.csv",name:"Disney"}
  {key:"apple",file:"apple.csv",name:"Apple"}
  {key:"madrid",file:"madrid.csv",name:"Madrid"}
]
